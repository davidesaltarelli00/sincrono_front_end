...
@Component({
  selector: 'app-aggiungi-commessa',
  templateUrl: './aggiungi-commessa.component.html',
  styleUrls: ['./aggiungi-commessa.component.scss'],
})
export class AggiungiCommessaComponent {
  utenti: any = [];
  maxCommessaId: any;
  data: any;
